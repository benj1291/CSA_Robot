...
namespace RobotView
{
    public partial class CommonRunParameters : UserControl
    {
        ...
        {
            this.Focus();
            upDownSpeed.Value = KeyBoard.ShowBox(upDownSpeed.Value, upDownSpeed.Minimum, upDownSpeed.Maximum);
        }

        private void upDownAccleration_GotFocus(object sender, EventArgs e)
        {
            this.Focus();
            upDownAcceleration.Value = KeyBoard.ShowBox(upDownAcceleration.Value, upDownAcceleration.Minimum, upDownAcceleration.Maximum);
        }
